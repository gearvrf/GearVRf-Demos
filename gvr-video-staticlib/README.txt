...
2) put all the collected *.jar files into libs folder, e.g., gvr-video-staticlib\gvrvideo\src\main\libs
3) put all the collected *.so files into the libs fodler, e.g., gvr-video-staticlib\gvrvideo\src\main\libs\lib\armeabi-v7a\
4) For AndroidStdudio, zip the lib\armeabi-v7a\ folder from the libs\ folder, and rename it to lib.jar (to carry the *.so files)
