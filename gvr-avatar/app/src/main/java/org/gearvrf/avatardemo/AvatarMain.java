...
public class AvatarMain extends GVRMain {
    ...
    //
    // These animations and bone map use the Mixamo skeleton only
    //
    ...
    //private final String mBoneMapPath = "mixamo_mixamo.txt";

    //
    // These animations and bone map map the Arcsoft skeleton to the Mixamo one
    // and they use Arcsoft BVH files. Any BVH file generated by Arcsoft will work here.
    //
    private final String[] mAnimationPaths = {"test.bvh", "shoulder_updown.bvh"};
    private final String mBoneMapPath = "YBot/arcsoft_ybot.txt";
    ...
    private void loadNextAnimation()
    {
        if (mNumAnimsLoaded < mAnimationPaths.length)
        {
            try
            {
                ...
                mAvatar.loadAnimation(res, mBoneMap);
                ++mNumAnimsLoaded;
            }
