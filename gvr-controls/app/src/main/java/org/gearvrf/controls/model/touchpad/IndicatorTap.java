...
public class IndicatorTap extends GVRSceneObject {
    ...
    public IndicatorTap(GVRContext gvrContext, float width, float height, GVRTexture texture) {
    ...
    public void pressed() {
        ...
        opacityAnimationOn.setRepeatCount(2);
        opacityAnimationOn.setRepeatMode(GVRRepeatMode.PINGPONG);
