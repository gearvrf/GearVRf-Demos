...
2) put all the collected *.jar files into libs folder, e.g., gvr-video-staticlib\gvrvideo\libs\
3) put all the collected *.so files into the libs fodler, e.g., gvr-video-staticlib\gvrvideo\libs\lib\armeabi-v7a\
4) if an Android Studio project, zip the lib\ folder from the libs\ folder, and rename it to lib.jar
