...
public class ViewerMain extends GVRMain {
    ...
    ViewerMain(GVRActivity activity) {
        mActivity = activity;
    }
    ...
    public void onInit(GVRContext gvrContext) {
        ...
        try {
            GVRTexture env_tex = loader.loadTexture(new GVRAndroidResource(mGVRContext, "env.jpg"));
            ...
            // car
            GVRTexture car_body_tex = loader.loadTexture(new GVRAndroidResource(mGVRContext, "car/body.jpg"));
            ...
            // robot
            GVRTexture robot_head_tex = loader.loadTexture(new GVRAndroidResource(mGVRContext, "robot/head.jpg"));
            ...
            // leaf
            GVRTexture leaf_box_tex = loader.loadTexture(new GVRAndroidResource(mGVRContext, "leaf/box.jpg"));
            ...
            GVRMesh mesh1 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "watch/frame.obj"));
            ...
            GVRMesh mesh2 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "watch/board.obj"));
            ...
            GVRMesh mesh3 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "watch/glass.obj"));
            ...
            GVRMesh mesh5 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "jar/jar.obj"));
            ...
            GVRMesh mesh4 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "jar/edge.obj"));
            ...
            GVRMesh mesh6 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/body.obj"));
            ...
            GVRMesh mesh9 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/tire.obj"));
            ...
            GVRMesh mesh10 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/glass.obj"));
            ...
            GVRMesh mesh11 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/wheel.obj"));
            ...
            GVRMesh mesh12 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/back.obj"));
            ...
            GVRMesh mesh13 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/grill.obj"));
            ...
            GVRMesh mesh14 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/glass2.obj"));
            ...
            GVRMesh mesh19 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "car/inside.obj"));
            ...
            GVRMesh mesh15 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "robot/body.obj"));
            ...
            GVRMesh mesh16 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "robot/head.obj"));
            ...
            GVRMesh mesh17 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "robot/metal.obj"));
            ...
            GVRMesh mesh18 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "robot/rubber.obj"));
            ...
            GVRMesh mesh20 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "leaf/leaf.obj"));
            ...
            GVRMesh mesh21 = loader.loadMesh(new GVRAndroidResource(mGVRContext, "leaf/box.obj"));
            ...
            ThumbnailTextures[0] = loader.loadTexture(new GVRAndroidResource(mGVRContext,
                            "leaf/leaf.jpg"));
            ThumbnailTextures[1] = loader.loadTexture(new GVRAndroidResource(mGVRContext,
                            "jar/jar.png"));
            ThumbnailTextures[2] = loader.loadTexture(new GVRAndroidResource(mGVRContext,
                            "watch/watch.png"));
            ThumbnailTextures[3] = loader.loadTexture(new GVRAndroidResource(mGVRContext,
                            "car/car.png"));
            ThumbnailTextures[4] = loader.loadTexture(new GVRAndroidResource(mGVRContext,
                            "robot/robot.jpg"));
            ...
            GVRMesh glass_mesh = loader.loadMesh(new GVRAndroidResource(
                    mGVRContext, "glass.obj"));
            GVRMesh board_mesh = loader.loadMesh(new GVRAndroidResource(
                    mGVRContext, "board.obj"));
            GVRMesh picks_mesh = loader.loadMesh(new GVRAndroidResource(
            ...
            GVRTexture m360 = loader.loadTexture(new GVRAndroidResource(mGVRContext, "env.jpg"));
            GVRMesh sphere = loader.loadMesh(new GVRAndroidResource(mGVRContext, "sphere.obj"));
