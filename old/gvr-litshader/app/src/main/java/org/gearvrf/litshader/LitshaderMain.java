...
public class LitshaderMain extends GVRMain {
    ...
    public void onInit(GVRContext gvrContext) {
        ...
        mLight.setSpecularIntensity(0f, 0f, 0f, 1.0f);
        ...
        rotateObject.getRenderData().setMaterial(litMaterial);
         ...
         lightObject = new GVRSceneObject(gvrContext);
        lightObject.getTransform().setPosition(LIGHT_ROTATE_RADIUS, 0.0f, LIGHT_Z);
    ...
    public void onStep() {
        ...
        lightObject.getTransform().setPosition((float) sine * LIGHT_ROTATE_RADIUS, (float) cosine
