...
public class ReflectionShader extends GVRShader {
...
//            + "uniform float u_radius;\n" //
            ...
            + "  outColor = vec4( color, 0.7-0.3*viewing );\n"
    ...
    public ReflectionShader(GVRContext gvrContext) {
        ...
        super("float4 u_mat1, float4 u_mat2, float4 u_mat3, float4 u_mat4, float3 u_eye, float3 u_light, float4 u_color, float u_radius ", "sampler2D intexture", "float3 a_position, float3 a_normal, float2 a_tex_coord",300);
