...
public class LoadComponentTextBackGround extends GVRSceneObject implements FocusListener {
    ...
    public LoadComponentTextBackGround(GVRContext gvrContext, LoadComponentListener componentListener) {
        super(gvrContext);
    ...
    public void setFloatTexture() {
        ...
        drawFrameListener = new GVRDrawFrameListener() {
            ...
            public void onDrawFrame(float arg0) {
                valueFloatTexture += 0.005f;

                if (valueFloatTexture <= 1) {
                    circleAlpha.getRenderData().getMaterial()
                            .setFloat(CutoutShader.CUTOUT, valueFloatTexture);

                } else if (valueFloatTexture >= 1 && valueFloatTexture <= 1.01) {
