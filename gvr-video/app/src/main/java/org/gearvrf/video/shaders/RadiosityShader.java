...
public class RadiosityShader extends GVRShader {
    ...
    public RadiosityShader(GVRContext gvrContext) {
        ...
        super("float u_weight, float u_fade, float u_lightness", "samplerExternalOES u_screen sampler2D u_texture_off", "float3 a_position, float3 a_normal, float2 a_tex_coord", 300);
