...
public class Main extends GVRMain implements KeyboardEventListener {
    ...
    public class PickHandler implements IPickEvents
    {
        ...
        public void onNoPick(GVRPicker picker)
        {
            ...
            {
                if (lastSelectedSphereFlag.answerState == SphereStaticList.ANSWERING)
                {
        ...
        public void onPick(GVRPicker picker)
        {
            ...
            if (!keyboard.isEnabled() &&
                (dashboard.hashCode() != sceneObject.hashCode()))
            {
                interactWithVisibleObjects(sceneObject, picked[0].getHitLocation());
            }
            if (lastSelectedSphereFlag != null)
            {
                if (dashboard != null)
                ...
                if (sceneObject.equals(lastSelectedSphereFlag))
                {
    ...
    private void moveObject(GVRSceneObject object, float [] hitLocation) {
