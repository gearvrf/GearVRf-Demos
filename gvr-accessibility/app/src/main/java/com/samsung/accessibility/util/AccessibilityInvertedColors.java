...
public class AccessibilityInvertedColors {

    private GVRPostEffect postEffect;
    private AccessibilityPostEffectShader shaderManager;
    private boolean mInverted;
    private GVRContext mGvrContext;

    public AccessibilityInvertedColors(final GVRContext gvrContext) {
        mGvrContext = gvrContext;
        gvrContext.runOnGlThread(new Runnable() {

            @Override
            public void run() {
                shaderManager = new AccessibilityPostEffectShader(gvrContext);
